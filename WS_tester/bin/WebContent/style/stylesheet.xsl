<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:report="http://www.nist.gov/healthcare/validation/message/hl7/v2/report" xmlns:message="http://www.nist.gov/healthcare/validation/message" xmlns:context="http://www.nist.gov/healthcare/validation/message/hl7/v2/context" xmlns:profile="http://www.nist.gov/healthcare/profile" xmlns:map="urn:internal" exclude-result-prefixes="map">
	...
	<xsl:template match="report:SpecificReport">
		...
		<div id="mvrMessageContentBox" style="display:{$msgContentDisplay};">
			...
			<textarea rows="10" cols="80" readonly="true" wrap="off">
					<xsl:value-of select="report:MetaData/report:Message/report:Er7Message"/>
            </textarea>
            </div>
			</td>	
			</tr>
		...
		<tr>
			...
			<td class="{$row}" colspan="2">
				...
				<xsl:call-template name="replace">
        			<xsl:with-param name="string" select="report:Description"/>
    			</xsl:call-template>
